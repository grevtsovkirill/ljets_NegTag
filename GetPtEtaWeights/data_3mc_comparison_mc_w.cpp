...
void data_3mc_comparison_mc_w()
{
  ...
  for(int ivar=0; ivar<histo_var.size(); ivar++)
  {
    ...
    for(int ijet=1; ijet<3; ijet++)
    {
      ...
      TH1D *h_mc_SHERPA = (TH1D*)h_tmp->Clone(histo_mc_SHERPA_name.c_str());
      h_tmp =NULL;
         ...
         histo_var.at(ivar)=="jet_JetFitterFlip_dRFlightDir")
      {
        ...
        h_mc_SHERPA->GetXaxis()->SetRangeUser(0,2);
      }
         ...
         histo_var.at(ivar)=="jet_JetFitterFlip_N2Tpair")
      {
        ...
        h_mc_SHERPA->GetXaxis()->SetRangeUser(0,30);
      }
         ...
         histo_var.at(ivar)=="jet_JetFitterFlip_nVTX")
      {
        ...
        h_mc_SHERPA->GetXaxis()->SetRangeUser(0,10);
      }
      ...
      if(flag_logy)
      {
        ...
        h_mc_SHERPA->SetMaximum(h_mc_SHERPA->GetMaximum()*10000);
      }
      if(!flag_logy)
      {
        ...
        h_mc_SHERPA->SetMaximum(h_mc_SHERPA->GetMaximum()*1.3);
      }
      ...
      TH1D *h_ratio_SHERPA = (TH1D*)h_data->Clone(histo_ratio_SHERPA_name.c_str());
      h_ratio->Divide(h_mc); 
      h_ratio_HERWIG->Divide(h_mc_HERWIG); 
      h_ratio_SHERPA->Divide(h_mc_SHERPA); 

      h_ratio->SetMaximum(5);
      h_ratio_HERWIG->SetMaximum(5);
      h_ratio_SHERPA->SetMaximum(5);
      ...
      TCanvas *c_SHERPA = new TCanvas(canvas_SHERPA_name.c_str(), "", 800, 900);
