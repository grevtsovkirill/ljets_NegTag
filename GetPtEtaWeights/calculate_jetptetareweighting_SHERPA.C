...
void calculate_jetptetareweighting_SHERPA(int dosyst=0)
{
  ...
  TFile* ff_mc = new TFile("mc_FlavourTagging_SHERPA.root");
  const int njet = 2;
  TH2D* h_ratio[njet];

  TFile* ff_out = new TFile("rew_SHERPA.root", "RECREATE");
