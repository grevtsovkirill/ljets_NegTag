...
void data_mc_comparison_all_rew(string compaigne="a", string dname="data_FlavourTagging_Nominal_0.root",string mname="mc_FlavourTagging_Nominal_Pythia.root",string mHname="mc_FlavourTagging_Nominal_Herwig.root")
{
  SetAtlasStyle();
  ...
  for(int ivar=0; ivar<histo_var.size(); ivar++)
  {
    ...
    for(int ijet=1; ijet<3; ijet++)
    {
      ...
      legend->AddEntry(h_data,"Data + stat. unc.","LPE");
      legend->AddEntry(h_mc,"Pythia MC + stat. unc.","LPE");
      ...
      legend_HERWIG->AddEntry(h_data,"Data + stat. unc.","LPE");
      legend_HERWIG->AddEntry(h_mc_HERWIG,"HERWIG++ MC + stat. unc.","LPE");
