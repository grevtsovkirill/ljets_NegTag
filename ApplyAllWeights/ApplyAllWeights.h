...
#ifndef ApplyAllWeights_h
#define ApplyAllWeights_h
...
Int_t ApplyAllWeights::GetEntry(Long64_t entry)
{
...
Long64_t ApplyAllWeights::LoadTree(Long64_t entry)
{
...
void ApplyAllWeights::Init(TTree *tree)
{
...
void ApplyAllWeights::Show(Long64_t entry)
{
...
Int_t ApplyAllWeights::Cut(Long64_t entry)
{
