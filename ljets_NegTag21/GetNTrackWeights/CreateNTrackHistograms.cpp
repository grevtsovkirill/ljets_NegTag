...
void CreateNTrackHistograms::Loop(int bootstrap_bkeeper=0)
{
  ...
  TH1D* h_ntrackjets_event_pteta_rew;
  ...
  TH1D* h_trackpt1_pteta_rew;
  TH1D* h_tracketa1_pteta_rew;
  TH1D* h_trackpt_thin1_pteta_rew;
  TH1D* h_tracketa_thin1_pteta_rew;
  TH1D* h_trackphi1_pteta_rew;
  ...
  std::vector<TH1D*> h_float_subtagger1_track_pteta_rew;
  std::vector<TH1D*> h_int_subtagger1_track_pteta_rew;
  std::vector<TH1D*> h_double_subtagger1_track_pteta_rew;
  ...
  TH1D* h_trackntrk_IP3DNeg1_pteta_rew;
  TH1D* h_trackntrk_IP3D1_pteta_rew;
  TH1D* h_trackntrk_IP2DNeg1_pteta_rew;
  TH1D* h_trackntrk_IP2D1_pteta_rew;
  TH1D* h_trackntrk_SV1Flip1_pteta_rew;
  TH1D* h_trackntrk_SV11_pteta_rew;
  TH1D* h_trackntrk_JetFitterFlip1_pteta_rew;
  TH1D* h_trackntrk_JetFitter1_pteta_rew;


  // 2D - kinematics
  TH2D* h_pteta1_pteta_rew;
  TH2D* h_trackpteta1_pteta_rew; 
  // 2D - ntrk
  ...
  TH2D* h_trackntrk_IP3DNeg_pt1_pteta_rew;
  TH2D* h_trackntrk_IP3D_pt1_pteta_rew;
  TH2D* h_trackntrk_IP2DNeg_pt1_pteta_rew;
  TH2D* h_trackntrk_IP2D_pt1_pteta_rew;
  TH2D* h_trackntrk_SV1Flip_pt1_pteta_rew;
  TH2D* h_trackntrk_SV1_pt1_pteta_rew;
  TH2D* h_trackntrk_JetFitterFlip_pt1_pteta_rew;
  TH2D* h_trackntrk_JetFitter_pt1_pteta_rew;
  ...
  TH1D* h_trackpt2_pteta_rew;
  TH1D* h_tracketa2_pteta_rew;
  TH1D* h_trackpt_thin2_pteta_rew;
  TH1D* h_tracketa_thin2_pteta_rew;
  TH1D* h_trackphi2_pteta_rew;
  ...
  std::vector<TH1D*> h_float_subtagger2_track_pteta_rew;
  std::vector<TH1D*> h_int_subtagger2_track_pteta_rew;
  std::vector<TH1D*> h_double_subtagger2_track_pteta_rew;
  ...
  TH1D* h_trackntrk_IP3DNeg2_pteta_rew;
  TH1D* h_trackntrk_IP3D2_pteta_rew;
  TH1D* h_trackntrk_IP2DNeg2_pteta_rew;
  TH1D* h_trackntrk_IP2D2_pteta_rew;
  TH1D* h_trackntrk_SV1Flip2_pteta_rew;
  TH1D* h_trackntrk_SV12_pteta_rew;
  TH1D* h_trackntrk_JetFitterFlip2_pteta_rew;
  TH1D* h_trackntrk_JetFitter2_pteta_rew;

  // 2D - kinematics
  TH2D* h_pteta2_pteta_rew;
  TH2D* h_trackpteta2_pteta_rew;
  ...
  TH2D* h_trackntrk_IP3DNeg_pt2_pteta_rew;
  TH2D* h_trackntrk_IP3D_pt2_pteta_rew;
  TH2D* h_trackntrk_IP2DNeg_pt2_pteta_rew;
  TH2D* h_trackntrk_IP2D_pt2_pteta_rew;
  TH2D* h_trackntrk_SV1Flip_pt2_pteta_rew;
  TH2D* h_trackntrk_SV1_pt2_pteta_rew;
  TH2D* h_trackntrk_JetFitterFlip_pt2_pteta_rew;
  TH2D* h_trackntrk_JetFitter_pt2_pteta_rew;
  ...
  if (!m_systematic.EqualTo("FlavourTagging_Nominal") || bootstrap_bkeeper<=1 )
  {
    ...
    h_ntrackjets_event_pteta_rew = new TH1D("ntrackjets_event_pteta_rew", "", 20, 0, 20);
    ...
    h_trackpt1_pteta_rew = new TH1D("trackpt1_pteta_rew", "", conf::n_pt, conf::pt_lowedges);
    h_tracketa1_pteta_rew = new TH1D("tracketa1_pteta_rew", "", conf::n_eta, conf::eta_lowedges);
    h_trackpt_thin1_pteta_rew = new TH1D("trackpt_thin1_pteta_rew", "", 600, 0., 3000.);
    h_tracketa_thin1_pteta_rew = new TH1D("tracketa_thin1_pteta_rew", "", 25, 0., 2.5);
    h_trackphi1_pteta_rew = new TH1D("trackphi1_pteta_rew", "", 60, -3.16, 3.16);
    ...
    for (const auto &name: subtagger::floats_trackjet){
      TH1D *h_tmp = new TH1D((name.first + "1_pteta_rew").c_str(),"",std::get<0>(name.second), std::get<1>(name.second), std::get<2>(name.second));
      h_tmp->Sumw2();
      h_float_subtagger1_track_pteta_rew.push_back(h_tmp);
    }
    for (const auto &name: subtagger::ints_trackjet){
      TH1D *h_tmp = new TH1D((name.first + "1_pteta_rew").c_str(),"",std::get<0>(name.second), std::get<1>(name.second), std::get<2>(name.second));
      h_tmp->Sumw2();
      h_int_subtagger1_track_pteta_rew.push_back(h_tmp);
    }
    for (const auto &name: subtagger::doubles_trackjet){
      TH1D *h_tmp = new TH1D((name.first + "1_pteta_rew").c_str(),"",std::get<0>(name.second), std::get<1>(name.second), std::get<2>(name.second));
      h_tmp->Sumw2();
      h_double_subtagger1_track_pteta_rew.push_back(h_tmp);
    }
    ...
    h_trackntrk_IP3DNeg1_pteta_rew = new TH1D("trackntrk_IP3DNeg1_pteta_rew","",25, 0, 25);
    h_trackntrk_IP3D1_pteta_rew = new TH1D("trackntrk_IP3D1_pteta_rew","",25, 0, 25);
    h_trackntrk_IP2DNeg1_pteta_rew = new TH1D("trackntrk_IP2DNeg1_pteta_rew","",25, 0, 25);
    h_trackntrk_IP2D1_pteta_rew = new TH1D("trackntrk_IP2D1_pteta_rew","",25, 0, 25);
    h_trackntrk_SV1Flip1_pteta_rew = new TH1D("trackntrk_SV1Flip1_pteta_rew","",25, 0, 25);
    h_trackntrk_SV11_pteta_rew = new TH1D("trackntrk_SV11_pteta_rew","",25, 0, 25);
    h_trackntrk_JetFitterFlip1_pteta_rew = new TH1D("trackntrk_JetFitterFlip1_pteta_rew","",25, 0, 25);
    h_trackntrk_JetFitter1_pteta_rew = new TH1D("trackntrk_JetFitter1_pteta_rew","",25, 0, 25);

    // 2D - kinematics
    h_pteta1_pteta_rew = new TH2D("pteta1_pteta_rew", "", conf::n_pt, conf::pt_lowedges, conf::n_eta, conf::eta_lowedges);
    h_trackpteta1_pteta_rew = new TH2D("trackpteta1_pteta_rew", "", conf::n_pt, conf::pt_lowedges, conf::n_eta, conf::eta_lowedges);
    ...
    h_trackntrk_IP3DNeg_pt1_pteta_rew = new TH2D("trackntrk_IP3DNeg_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_IP3D_pt1_pteta_rew = new TH2D("trackntrk_IP3D_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_IP2DNeg_pt1_pteta_rew = new TH2D("trackntrk_IP2DNeg_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_IP2D_pt1_pteta_rew = new TH2D("trackntrk_IP2D_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_SV1Flip_pt1_pteta_rew = new TH2D("trackntrk_SV1Flip_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_SV1_pt1_pteta_rew = new TH2D("trackntrk_SV1_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_JetFitterFlip_pt1_pteta_rew = new TH2D("trackntrk_JetFitterFlip_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_JetFitter_pt1_pteta_rew = new TH2D("trackntrk_JetFitter_pt1_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    ...
    h_trackpt2_pteta_rew = new TH1D("trackpt2_pteta_rew", "", conf::n_pt, conf::pt_lowedges);
    h_tracketa2_pteta_rew = new TH1D("tracketa2_pteta_rew", "", conf::n_eta, conf::eta_lowedges);
    h_trackpt_thin2_pteta_rew = new TH1D("trackpt_thin2_pteta_rew", "", 600, 0., 3000.);
    h_tracketa_thin2_pteta_rew = new TH1D("tracketa_thin2_pteta_rew", "", 25, 0., 2.5);
    h_trackphi2_pteta_rew = new TH1D("trackphi2_pteta_rew", "", 60, -3.16, 3.16);
    ...
    for (const auto &name: subtagger::floats_trackjet){
      TH1D *h_tmp = new TH1D((name.first + "2_pteta_rew").c_str(),"",std::get<0>(name.second), std::get<1>(name.second), std::get<2>(name.second));
      h_tmp->Sumw2();
      h_float_subtagger2_track_pteta_rew.push_back(h_tmp);
    }
    for (const auto &name: subtagger::ints_trackjet){
      TH1D *h_tmp = new TH1D((name.first + "2_pteta_rew").c_str(),"",std::get<0>(name.second), std::get<1>(name.second), std::get<2>(name.second));
      h_tmp->Sumw2();
      h_int_subtagger2_track_pteta_rew.push_back(h_tmp);
    }
    for (const auto &name: subtagger::doubles_trackjet){
      TH1D *h_tmp = new TH1D((name.first + "2_pteta_rew").c_str(),"",std::get<0>(name.second), std::get<1>(name.second), std::get<2>(name.second));
      h_tmp->Sumw2();
      h_double_subtagger2_track_pteta_rew.push_back(h_tmp);
    }
    ...
    h_trackntrk_IP3DNeg2_pteta_rew = new TH1D("trackntrk_IP3DNeg2_pteta_rew","",25, 0, 25);
    h_trackntrk_IP3D2_pteta_rew = new TH1D("trackntrk_IP3D2_pteta_rew","",25, 0, 25);
    h_trackntrk_IP2DNeg2_pteta_rew = new TH1D("trackntrk_IP2DNeg2_pteta_rew","",25, 0, 25);
    h_trackntrk_IP2D2_pteta_rew = new TH1D("trackntrk_IP2D2_pteta_rew","",25, 0, 25);
    h_trackntrk_SV1Flip2_pteta_rew = new TH1D("trackntrk_SV1Flip2_pteta_rew","",25, 0, 25);
    h_trackntrk_SV12_pteta_rew = new TH1D("trackntrk_SV12_pteta_rew","",25, 0, 25);
    h_trackntrk_JetFitterFlip2_pteta_rew = new TH1D("trackntrk_JetFitterFlip2_pteta_rew","",25, 0, 25);
    h_trackntrk_JetFitter2_pteta_rew = new TH1D("trackntrk_JetFitter2_pteta_rew","",25, 0, 25);

    // 2D - kinematics
    h_pteta2_pteta_rew = new TH2D("pteta2_pteta_rew", "", conf::n_pt, conf::pt_lowedges, conf::n_eta, conf::eta_lowedges);
    h_trackpteta2_pteta_rew = new TH2D("trackpteta2_pteta_rew", "", conf::n_pt, conf::pt_lowedges, conf::n_eta, conf::eta_lowedges);
    ...
    h_trackntrk_IP3DNeg_pt2_pteta_rew = new TH2D("trackntrk_IP3DNeg_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_IP3D_pt2_pteta_rew = new TH2D("trackntrk_IP3D_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_IP2DNeg_pt2_pteta_rew = new TH2D("trackntrk_IP2DNeg_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_IP2D_pt2_pteta_rew = new TH2D("trackntrk_IP2D_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_SV1Flip_pt2_pteta_rew = new TH2D("trackntrk_SV1Flip_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_SV1_pt2_pteta_rew = new TH2D("trackntrk_SV1_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_JetFitterFlip_pt2_pteta_rew = new TH2D("trackntrk_JetFitterFlip_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);
    h_trackntrk_JetFitter_pt2_pteta_rew = new TH2D("trackntrk_JetFitter_pt2_pteta_rew","",25, 0, 25, conf::n_pt, conf::pt_lowedges);

    // Correct uncertainties for weighted histograms
    h_njets_event_pteta_rew->Sumw2();
    h_ntrackjets_event_pteta_rew->Sumw2();
    ...
    h_trackpt1_pteta_rew->Sumw2();
    h_tracketa1_pteta_rew->Sumw2();
    h_trackpt_thin1_pteta_rew->Sumw2();
    h_tracketa_thin1_pteta_rew->Sumw2();
    h_trackphi1_pteta_rew->Sumw2();
    ...
    h_trackntrk_IP3DNeg1_pteta_rew->Sumw2();
    h_trackntrk_IP3D1_pteta_rew->Sumw2();
    h_trackntrk_IP2DNeg1_pteta_rew->Sumw2();
    h_trackntrk_IP2D1_pteta_rew->Sumw2();
    h_trackntrk_SV1Flip1_pteta_rew->Sumw2();
    h_trackntrk_SV11_pteta_rew->Sumw2();
    h_trackntrk_JetFitterFlip1_pteta_rew->Sumw2();
    h_trackntrk_JetFitter1_pteta_rew->Sumw2();

    h_pteta1_pteta_rew->Sumw2();
    h_trackpteta1_pteta_rew->Sumw2();
    ...
    h_trackntrk_IP3DNeg_pt1_pteta_rew->Sumw2();
    h_trackntrk_IP3D_pt1_pteta_rew->Sumw2();
    h_trackntrk_IP2DNeg_pt1_pteta_rew->Sumw2();
    h_trackntrk_IP2D_pt1_pteta_rew->Sumw2();
    h_trackntrk_SV1Flip_pt1_pteta_rew->Sumw2();
    h_trackntrk_SV1_pt1_pteta_rew->Sumw2();
    h_trackntrk_JetFitterFlip_pt1_pteta_rew->Sumw2();
    h_trackntrk_JetFitter_pt1_pteta_rew->Sumw2();
    ...
    h_trackpt2_pteta_rew->Sumw2();
    h_tracketa2_pteta_rew->Sumw2();
    h_trackpt_thin2_pteta_rew->Sumw2();
    h_tracketa_thin2_pteta_rew->Sumw2();
    h_trackphi2_pteta_rew->Sumw2();
    ...
    h_trackntrk_IP3DNeg2_pteta_rew->Sumw2();
    h_trackntrk_IP3D2_pteta_rew->Sumw2();
    h_trackntrk_IP2DNeg2_pteta_rew->Sumw2();
    h_trackntrk_IP2D2_pteta_rew->Sumw2();
    h_trackntrk_SV1Flip2_pteta_rew->Sumw2();
    h_trackntrk_SV12_pteta_rew->Sumw2();
    h_trackntrk_JetFitterFlip2_pteta_rew->Sumw2();
    h_trackntrk_JetFitter2_pteta_rew->Sumw2();
 
    h_pteta2_pteta_rew->Sumw2();
    h_trackpteta2_pteta_rew->Sumw2();
    ...
    h_trackntrk_IP3DNeg_pt2_pteta_rew->Sumw2();
    h_trackntrk_IP3D_pt2_pteta_rew->Sumw2();
    h_trackntrk_IP2DNeg_pt2_pteta_rew->Sumw2();
    h_trackntrk_IP2D_pt2_pteta_rew->Sumw2();
    h_trackntrk_SV1Flip_pt2_pteta_rew->Sumw2();
    h_trackntrk_SV1_pt2_pteta_rew->Sumw2();
    h_trackntrk_JetFitterFlip_pt2_pteta_rew->Sumw2();
    h_trackntrk_JetFitter_pt2_pteta_rew->Sumw2();
  ...
  TH2D* array_data_h_trackntrk_pt1[2];
  TH2D* array_data_h_trackntrk_pt2[2];
  TH2D* array_mc_h_ntrk_pt1[2];
  TH2D* array_mc_h_ntrk_pt2[2]; 
  TH2D* array_mc_h_trackntrk_pt1[2];
  TH2D* array_mc_h_trackntrk_pt2[2];
  ...
  if ( m_systematic.EqualTo("FlavourTagging_Nominal")  && bootstrap_bkeeper>0)
  {
     for(int ibootstrap=0; ibootstrap<2; ibootstrap++)
     {
       ...
       array_data_h_trackntrk_pt1[ibootstrap] = new TH2D( (string("trackntrk_pt1_pteta_rew_data_") + to_string((bootstrap_bkeeper-1)*2+ibootstrap)).c_str(), "", 25, 0, 25, conf::n_pt, conf::pt_lowedges);

       array_data_h_trackntrk_pt2[ibootstrap] = new TH2D( (string("trackntrk_pt2_pteta_rew_data_") + to_string((bootstrap_bkeeper-1)*2+ibootstrap)).c_str(), "", 25, 0, 25, conf::n_pt, conf::pt_lowedges);

       array_data_h_ntrk_pt1[ibootstrap]->Sumw2();
       array_data_h_ntrk_pt2[ibootstrap]->Sumw2();
       array_data_h_trackntrk_pt1[ibootstrap]->Sumw2();
       array_data_h_trackntrk_pt2[ibootstrap]->Sumw2();
       ...
       if(runmc)
       {
         ...
         array_mc_h_trackntrk_pt1[ibootstrap] = new TH2D( (string("trackntrk_pt1_pteta_rew_mc_") + to_string((bootstrap_bkeeper-1)*2+ibootstrap)).c_str(), "", 25, 0, 25, conf::n_pt, conf::pt_lowedges);
         array_mc_h_trackntrk_pt2[ibootstrap] = new TH2D( (string("trackntrk_pt2_pteta_rew_mc_") + to_string((bootstrap_bkeeper-1)*2+ibootstrap)).c_str(), "", 25, 0, 25, conf::n_pt, conf::pt_lowedges);

         array_mc_h_ntrk_pt1[ibootstrap]->Sumw2();
         array_mc_h_ntrk_pt2[ibootstrap]->Sumw2();
         array_mc_h_trackntrk_pt1[ibootstrap]->Sumw2();
         array_mc_h_trackntrk_pt2[ibootstrap]->Sumw2();
    }
  ...
  for(int ij=0; ij<2; ij++){
    h_rew[ij] = (TH2D*)frew->Get( (string(m_systematic + "/" + prefix + "ptscale")+char('1'+ij)).c_str() );
  }
  ...
  if ( m_systematic.EqualTo("FlavourTagging_Nominal") && bootstrap_bkeeper>0)
  {
     ...
     {
       for(int ij=0; ij<2; ij++){
         array_data_h_rew[ij][ibootstrap] = (TH2D*)frew->Get( (string(m_systematic + "/" + prefix + "ptscale") + char('1'+ij) + string("_data_")+to_string((bootstrap_bkeeper-1)*2+ibootstrap) ).c_str() );
         array_mc_h_rew[ij][ibootstrap] = (TH2D*)frew->Get( (string(m_systematic + "/" + prefix + "ptscale") + char('1'+ij) + string("_mc_")+to_string((bootstrap_bkeeper-1)*2+ibootstrap) ).c_str() );
       }
     }
  }
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) 
  {
	...
	int ilead = trackisleading[j] ? 0 : 1;
	int ix = h_rew[ilead]->GetXaxis()->FindBin(trackjetpt[j] );
        int iy = h_rew[ilead]->GetYaxis()->FindBin( abs(trackjeteta[j]) );
	}
      ...
      if(isleading[j] && jetpass_leading==0 && jetpass_subleading<2 )
	{
	  ...
	  if (!m_systematic.EqualTo("FlavourTagging_Nominal") || bootstrap_bkeeper<=1 )
		...
		} // End of calo jet prefix loop.	      
	     if (prefix == "track"){ 
	     if (trackisleading[j]){
		h_trackpt1_pteta_rew->Fill(trackptj, weight);
                h_tracketa1_pteta_rew->Fill(tracketa_abs, weight);
                h_trackpt_thin1_pteta_rew->Fill(trackptj, weight);
                h_tracketa_thin1_pteta_rew->Fill(tracketa_abs, weight);
                h_trackphi1_pteta_rew->Fill(trackjetphi[j], weight);
	
              int k=0;
              for (const auto &name: subtagger::floats_trackjet){
                h_float_subtagger1_track_pteta_rew.at(k)->Fill(float_subtagger_trackjet[name.first][j], weight);
                k++;
              }

              k=0;
              for (const auto &name: subtagger::ints_trackjet){
                h_int_subtagger1_track_pteta_rew.at(k)->Fill(int_subtagger_trackjet[name.first][j], weight);
                k++;
              }

              k=0;
              for (const auto &name: subtagger::doubles_trackjet){
                h_double_subtagger1_track_pteta_rew.at(k)->Fill(double_subtagger_trackjet[name.first][j], weight);
                k++;
              }

	      h_trackntrk_IP3DNeg1_pteta_rew->Fill(trackntracks_IP3DNeg, weight);
              h_trackntrk_IP3D1_pteta_rew->Fill(trackntracks_IP3D, weight);
              h_trackntrk_IP2DNeg1_pteta_rew->Fill(trackntracks_IP2DNeg, weight);
              h_trackntrk_IP2D1_pteta_rew->Fill(trackntracks_IP2D, weight);
              h_trackntrk_SV1Flip1_pteta_rew->Fill(trackntracks_SV1Flip, weight);
              h_trackntrk_SV11_pteta_rew->Fill(trackntracks_SV1, weight);
              h_trackntrk_JetFitterFlip1_pteta_rew->Fill(trackntracks_JetFitterFlip, weight);
              h_trackntrk_JetFitter1_pteta_rew->Fill(trackntracks_JetFitter, weight);

              h_trackpteta1_pteta_rew->Fill(trackptj, tracketa_abs, weight);

              h_trackntrk_IP3DNeg_pt1_pteta_rew->Fill(trackntracks_IP3DNeg, trackptj, weight);
              h_trackntrk_IP3D_pt1_pteta_rew->Fill(trackntracks_IP3D, trackptj, weight);
              h_trackntrk_IP2DNeg_pt1_pteta_rew->Fill(trackntracks_IP2DNeg, trackptj, weight);
              h_trackntrk_IP2D_pt1_pteta_rew->Fill(trackntracks_IP2D, trackptj, weight);
              h_trackntrk_SV1Flip_pt1_pteta_rew->Fill(trackntracks_SV1Flip, trackptj, weight);
              h_trackntrk_SV1_pt1_pteta_rew->Fill(trackntracks_SV1, trackptj, weight);
              h_trackntrk_JetFitterFlip_pt1_pteta_rew->Fill(trackntracks_JetFitterFlip, trackptj, weight);
              h_trackntrk_JetFitter_pt1_pteta_rew->Fill(trackntracks_JetFitter, trackptj, weight);
	      } // End of leading track loop.
	      if (!trackisleading[j]){
                h_trackpt2_pteta_rew->Fill(trackptj, weight);
                h_tracketa2_pteta_rew->Fill(tracketa_abs, weight);
                h_trackpt_thin2_pteta_rew->Fill(trackptj, weight);
                h_tracketa_thin2_pteta_rew->Fill(tracketa_abs, weight);
                h_trackphi2_pteta_rew->Fill(trackjetphi[j], weight);

              int k=0;
              for (const auto &name: subtagger::floats_trackjet){
                h_float_subtagger2_track_pteta_rew.at(k)->Fill(float_subtagger_trackjet[name.first][j], weight);
                k++;
              }

              k=0;
              for (const auto &name: subtagger::ints_trackjet){
                h_int_subtagger2_track_pteta_rew.at(k)->Fill(int_subtagger_trackjet[name.first][j], weight);
                k++;
              }

              k=0;
              for (const auto &name: subtagger::doubles_trackjet){
                h_double_subtagger2_track_pteta_rew.at(k)->Fill(double_subtagger_trackjet[name.first][j], weight);
                k++;
              }

              h_trackntrk_IP3DNeg2_pteta_rew->Fill(trackntracks_IP3DNeg, weight);
              h_trackntrk_IP3D2_pteta_rew->Fill(trackntracks_IP3D, weight);
              h_trackntrk_IP2DNeg2_pteta_rew->Fill(trackntracks_IP2DNeg, weight);
              h_trackntrk_IP2D2_pteta_rew->Fill(trackntracks_IP2D, weight);
              h_trackntrk_SV1Flip2_pteta_rew->Fill(trackntracks_SV1Flip, weight);
              h_trackntrk_SV12_pteta_rew->Fill(trackntracks_SV1, weight);
              h_trackntrk_JetFitterFlip2_pteta_rew->Fill(trackntracks_JetFitterFlip, weight);
              h_trackntrk_JetFitter2_pteta_rew->Fill(trackntracks_JetFitter, weight);

              h_trackpteta2_pteta_rew->Fill(trackptj, tracketa_abs, weight);

              h_trackntrk_IP3DNeg_pt2_pteta_rew->Fill(trackntracks_IP3DNeg, trackptj, weight);
              h_trackntrk_IP3D_pt2_pteta_rew->Fill(trackntracks_IP3D, trackptj, weight);
              h_trackntrk_IP2DNeg_pt2_pteta_rew->Fill(trackntracks_IP2DNeg, trackptj, weight);
              h_trackntrk_IP2D_pt2_pteta_rew->Fill(trackntracks_IP2D, trackptj, weight);
              h_trackntrk_SV1Flip_pt2_pteta_rew->Fill(trackntracks_SV1Flip, trackptj, weight);
              h_trackntrk_SV1_pt2_pteta_rew->Fill(trackntracks_SV1, trackptj, weight);
              h_trackntrk_JetFitterFlip_pt2_pteta_rew->Fill(trackntracks_JetFitterFlip, trackptj, weight);
              h_trackntrk_JetFitter_pt2_pteta_rew->Fill(trackntracks_JetFitter, trackptj, weight);
              } // End of subleading trackjet loop.

	      } // End of track prefix loop. 
	     } //  End of histogram filling loop.
	  ...
	  if (m_systematic.EqualTo("FlavourTagging_Nominal") && bootstrap_bkeeper>0)
		...
		} // End calo jet prefix loop.
		if (prefix == "track"){	
			if(runmc){
		//datastat
                array_data_h_trackntrk_pt1[ibootstrap]->Fill(trackntracks_IP3DNeg, trackptj, weight_data[ibootstrap]);
                //mcstat 
                array_mc_h_trackntrk_pt1[ibootstrap]->Fill(trackntracks_IP3DNeg, trackptj, weight_mc[ibootstrap]*weight_bootstrap[(bootstrap_bkeeper-1)*2+ibootstrap]);
                          }                    
                // for data
                else
                {
                // mcstat required nominal data
                // datatstat
                array_data_h_trackntrk_pt1[ibootstrap]->Fill(trackntracks_IP3DNeg, trackptj, weight_data[ibootstrap]*weight_bootstrap[(bootstrap_bkeeper-1)*2+ibootstrap]);
		}
           } // End track jet prefix loop.
	 }	  
      } 
      // ---------- subleading jet ---------- //
      else if(!isleading[j])
	...
	if (prefix == "track"){
	 if (trackisleading[j]){
	  h_trackpt1_pteta_rew->Fill(trackptj, weight);
          ...
          h_trackntrk_JetFitterFlip_pt1_pteta_rew->Fill(trackntracks_JetFitterFlip, trackptj, weight);
          h_trackntrk_JetFitter_pt1_pteta_rew->Fill(trackntracks_JetFitter, trackptj, weight);
	  } // End of leading track jet loop.
	else if (!trackisleading[j]){
	  h_trackpt2_pteta_rew->Fill(trackptj, weight);
          h_tracketa2_pteta_rew->Fill(tracketa_abs, weight);
          h_trackpt_thin2_pteta_rew->Fill(trackptj, weight);
          h_tracketa_thin2_pteta_rew->Fill(tracketa_abs, weight);
          ...
          h_trackntrk_JetFitterFlip_pt2_pteta_rew->Fill(trackntracks_JetFitterFlip, trackptj, weight);
          h_trackntrk_JetFitter_pt2_pteta_rew->Fill(trackntracks_JetFitter, trackptj, weight);
	 } // End track jet sub leading loop.
	} // End track jet prefix loop.
	  ...
	  for(int ibootstrap=0; ibootstrap<2; ibootstrap++)
	   ...
	   if (prefix == "track"){
	    if(runmc)
            {
	      //datatstat
              array_data_h_trackntrk_pt2[ibootstrap]->Fill(trackntracks_IP3DNeg, trackptj, weight_data[ibootstrap]);
	      //mcstat
              array_mc_h_trackntrk_pt2[ibootstrap]->Fill(trackntracks_IP3DNeg, trackptj, weight_mc[ibootstrap]*weight_bootstrap[(bootstrap_bkeeper-1)*2+ibootstrap]);            
	   }
	   // for data
	   else {
	   // mcstat uses nominal data
	   // datatstat
           array_data_h_trackntrk_pt2[ibootstrap]->Fill(trackntracks_IP3DNeg, trackptj, weight_data[ibootstrap]*weight_bootstrap[(bootstrap_bkeeper-1)*2+ibootstrap]);

          }
	 } // End of track jet prefix loop.
        }	  
      }
    }
  }
