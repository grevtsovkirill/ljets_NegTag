...
#ifndef CreateNTrackHistograms_h
#define CreateNTrackHistograms_h
...
CreateNTrackHistograms::~CreateNTrackHistograms()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CreateNTrackHistograms::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CreateNTrackHistograms::LoadTree(Long64_t entry)
{
...
void CreateNTrackHistograms::Init(TTree *tree)
{
...
Bool_t CreateNTrackHistograms::Notify()
{
...
void CreateNTrackHistograms::Show(Long64_t entry)
{
...
Int_t CreateNTrackHistograms::Cut(Long64_t entry)
{
