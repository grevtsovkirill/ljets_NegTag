                        ...
                        if ((nominal.HLTj25 == 1) and ((nominal.trackjetpt[ltjindex] < 20.) and (nominal.trackjetpt[ltjindex] > 10.))):
                        	...
                        	if (tjflav == "l" ):
                        		...
                        		hMV2c10F_l.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                                    	hMV2c10_l_lowpt.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                                    	hMV2c10F_l_lowpt.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                        	if (tjflav == "b" ):
                        		hMV2c10_b.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                        		hMV2c10F_b.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                                    	hMV2c10_b_lowpt.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                                   	hMV2c10F_b_lowpt.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                        	if (tjflav == "c" ):
                        		hMV2c10_c.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                        		hMV2c10F_c.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                                    	hMV2c10_c_lowpt.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                                    	hMV2c10F_c_lowpt.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                                if (tjflav == "l" ):
				...
				hpT.Fill(nominal.trackjetpt[ltjindex], weight)
                        ...
                        if ((nominal.HLTj380 == 1) and (nominal.trackjetpt[ltjindex] > 150.)):
                        	...
                        	if (tjflav == "l" ):
                        		hMV2c10_l.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                        		hMV2c10F_l.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                                    	hMV2c10_l_highpt.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                                    	hMV2c10F_l_highpt.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                        	if (tjflav == "b" ):
                        		hMV2c10_b.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                        		hMV2c10F_b.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                                    	hMV2c10_b_highpt.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                                    	hMV2c10F_b_highpt.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                        	if (tjflav == "c" ):
                        		hMV2c10_c.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                        		hMV2c10F_c.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
                                    	hMV2c10_c_highpt.Fill(nominal.trackjet_MV2c10[ltjindex], weight)
                                    	hMV2c10F_c_highpt.Fill(nominal.trackjet_MV2c10Flip[ltjindex], weight)
